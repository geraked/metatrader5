...
| [AFAOSMD](Experts/AFAOSMD.mq5) | [:label: v1.1](https://github.com/geraked/metatrader5/raw/master/Build/AFAOSMD/AFAOSMD-v1.1.ex5) | [:arrow_forward:](https://youtu.be/UYBLh1IvIVs) | [:chart_with_upwards_trend:](Test/AFAOSMD) | A strategy using [Average Force](Indicators/AverageForce.mq5), [Andean Oscillator](Indicators/AndeanOscillator.mq5), and MACD |
...
| [LRCUTB](Experts/LRCUTB.mq5) | [:label: v1.0](https://github.com/geraked/metatrader5/raw/master/Build/LRCUTB/LRCUTB-v1.0.ex5) | [:arrow_forward:](https://youtu.be/0ZzLlA9NFxo) | [:chart_with_upwards_trend:](Test/LRCUTB) | A strategy using [Linear Regression Candles](Indicators/LinearRegressionCandles.mq5) and [UT Bot Alerts](Indicators/UTBot.mq5) |
